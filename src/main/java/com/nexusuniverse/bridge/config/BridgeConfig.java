...
public final class BridgeConfig {
    ...
    public int failureThreshold() { return Math.max(1, cfg.getInt("bridge.failure-threshold", 3)); }
    public long circuitOpenMs() { return Math.max(1000L, cfg.getLong("bridge.circuit-open-ms", 30000L)); }
    public long warningCooldownMs() { return Math.max(1000L, cfg.getLong("bridge.warning-cooldown-ms", 30000L)); }
